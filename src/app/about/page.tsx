      ...
      <>
        <div className="flex-col m-8 pl-10 md:pl-14 text-center">
          ...
          <div className="flex text-left mt-12">
            <motion.div className="flex-1 flex flex-col justify-center mr-16 text-black bg-softOlivine p-4"
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5, ease: 'easeOut' }}>

              <div className="bg-softZomp p-4">
          ...
          <div className="flex text-left mt-12">
            ...
            <motion.div className="flex-1 flex flex-col justify-center ml-16 text-black bg-softZomp p-4"
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5, ease: 'easeOut' }}>

              <div className="bg-softZomp p-4">
                <p className="whitespace-pre-wrap">    À travers mon expérience, j'ai entre autres développé mon-savoir faire en développement web en travaillant sur des projets innovants, notamment chez <Link className="text-charcoal underline italic" target="_blank" href="https://mynft.com/">MyNFT</Link> en participant à l'élaboration d'un site d'échange de NFT et plusieurs produits associés.
                <br/>    Puis chez <Link className="text-charcoal underline italic" target="_blank" href="https://www.oly-platform.com/">Oly Patform</Link> en prototypant l'automatisation de l'aquisition de données pour leur logiciel de vente de vêtements de seconde main sur une multitude de places de marché.
                <br/>    Et également chez <Link className="text-charcoal underline italic" target="_blank" href="https://www.protenga.com/">Protenga</Link>, qui crée des fermes d'élevage d'insectes high tech, en améliorant un système de comptage d'insectes.
                </p>
              </div>
              <br/>
